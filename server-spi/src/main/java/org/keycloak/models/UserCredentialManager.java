 ...
 *
 * @deprecated Instead of this class, use {@link UserModel#userCredentialManager()} instead.
...
public interface UserCredentialManager extends UserCredentialStore {
     ...
     * @param user
     * @return
     * @deprecated Use {@link UserModel#userCredentialManager()} and {@link SingleUserCredentialManager#getDisableableCredentialTypesStream()} instead.
     */
    @Deprecated
     ...
     *
     * @deprecated Use {@link UserModel#userCredentialManager()} and then call {@link SingleUserCredentialManager#getConfiguredUserStorageCredentialTypesStream()}
     * instead.
     */
    @Deprecated
    ...
    interface Streams extends UserCredentialManager, UserCredentialStore.Streams {
        ...
        default Set<String> getDisableableCredentialTypes(RealmModel realm, UserModel user) {
            return user.userCredentialManager().getDisableableCredentialTypesStream().collect(Collectors.toSet());
        }
        ...
        default List<String> getConfiguredUserStorageCredentialTypes(RealmModel realm, UserModel user) {
            return user.userCredentialManager().getConfiguredUserStorageCredentialTypesStream().collect(Collectors.toList());
        }
