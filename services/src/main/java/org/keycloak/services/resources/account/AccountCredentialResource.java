...
public class AccountCredentialResource {
    ...
    public Stream<CredentialContainer> credentialTypes(@QueryParam(TYPE) String type,
        ...
        Stream<CredentialModel> modelsStream = includeUserCredentials ? user.userCredentialManager().getStoredCredentialsStream() : Stream.empty();
        ...
        Function<CredentialProvider, CredentialContainer> toCredentialContainer = (credentialProvider) -> {
            ...
            if (includeUserCredentials) {
                ...
                if (userCredentialMetadataModels.isEmpty() &&
                        user.userCredentialManager().isConfiguredFor(credentialProvider.getType())) {
    ...
    public void removeCredential(final @PathParam("credentialId") String credentialId) {
        ...
        CredentialModel credential = user.userCredentialManager().getStoredCredentialById(credentialId);
        if (credential == null) {
            throw new NotFoundException("Credential not found");
        }
        user.userCredentialManager().removeStoredCredentialById(credentialId);
    }
    ...
    public void setLabel(final @PathParam("credentialId") String credentialId, String userLabel) {
        ...
        try {
            ...
            user.userCredentialManager().updateCredentialLabel(credentialId, label);
