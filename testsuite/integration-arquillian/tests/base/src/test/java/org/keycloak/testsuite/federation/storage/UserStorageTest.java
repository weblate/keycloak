...
//    @Test
    ...
    public void testCredentialCRUD(KeycloakSession session) throws Exception {
        ...
        KeycloakModelUtils.runJobInTransaction(session.getKeycloakSessionFactory(), (KeycloakSession currentSession) -> {
            ...
            Stream<CredentialModel> credentials = user.userCredentialManager().getStoredCredentialsStream();
            ...
            passwordCred = user.userCredentialManager().createStoredCredential(passwordCred);
            ...
            otp1 = user.userCredentialManager().createStoredCredential(otp1);
            otp2 = user.userCredentialManager().createStoredCredential(otp2);
        ...
        KeycloakModelUtils.runJobInTransaction(session.getKeycloakSessionFactory(), (KeycloakSession currentSession) -> {
            ...
            List<CredentialModel> list = user.userCredentialManager().getStoredCredentialsStream()
            ...
            assertFalse(user.userCredentialManager().moveStoredCredentialTo(passwordId.get(), "not-known"));

            // Assert can't move credential when not found
            assertFalse(user.userCredentialManager().moveStoredCredentialTo("not-known", otp2Id.get()));

            // Move otp2 up
            assertTrue(user.userCredentialManager().moveStoredCredentialTo(otp2Id.get(), passwordId.get()));
        });
        ...
        KeycloakModelUtils.runJobInTransaction(session.getKeycloakSessionFactory(), (KeycloakSession currentSession) -> {
            ...
            org.keycloak.testsuite.Assert.assertTrue(user.userCredentialManager().moveStoredCredentialTo(otp2Id.get(), null));
        });
        ...
        KeycloakModelUtils.runJobInTransaction(session.getKeycloakSessionFactory(), (KeycloakSession currentSession) -> {
            ...
            // Move password down
            assertTrue(user.userCredentialManager().moveStoredCredentialTo(passwordId.get(), otp1Id.get()));
        });
        ...
        KeycloakModelUtils.runJobInTransaction(session.getKeycloakSessionFactory(), (KeycloakSession currentSession) -> {
            ...
            // Remove password
            assertTrue(user.userCredentialManager().removeStoredCredentialById(passwordId.get()));
        });
    ...
    public void testCRUDCredentialsOfDifferentUser() {
        ...
        testingClient.server().run(session -> {
            ...
            CredentialModel otp1 = OTPCredentialModel.createFromPolicy(realm, "secret1");
            user.userCredentialManager().createStoredCredential(otp1);
        });
