...
public class LDAPProvidersIntegrationTest extends AbstractLDAPTest {
    ...
    public void testReadonly() {
        ...
        testingClient.server().run(session -> {
            ...
            try {
                ...
                user.userCredentialManager().updateCredential(cred);
                Assert.fail("should fail");
            } catch (ReadOnlyException e) {
    ...
    public void testUnsynced() throws Exception {
        ...
        testingClient.server().run(session -> {
            ...
            user.userCredentialManager().updateCredential(cred);
            CredentialModel userCredentialValueModel = user.userCredentialManager().getStoredCredentialsByTypeStream(PasswordCredentialModel.TYPE)
            ...
            Assert.assertTrue(user.userCredentialManager().isValid(cred));
