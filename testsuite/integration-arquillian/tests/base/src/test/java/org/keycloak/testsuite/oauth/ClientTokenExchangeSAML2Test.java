...
public class ClientTokenExchangeSAML2Test extends AbstractKeycloakTest {
    ...
    public static void setupRealm(KeycloakSession session) {
        ...
        bad.setEnabled(true);
        bad.userCredentialManager().updateCredential(UserCredentialModel.password("password"));
    }
    ...
    private static void addDirectExchanger(KeycloakSession session) {
        ...
        impersonatedUser.userCredentialManager().updateCredential(UserCredentialModel.password("password"));
