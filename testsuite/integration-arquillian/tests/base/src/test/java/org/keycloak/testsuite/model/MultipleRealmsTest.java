...
public class MultipleRealmsTest extends AbstractTestRealmKeycloakTest {
    ...
    public void testUsers(KeycloakSession session) {
        ...
        KeycloakModelUtils.runJobInTransaction(session.getKeycloakSessionFactory(), (KeycloakSession sessionTestUser1) -> {
            ...
            // Test password
            r1user1.userCredentialManager().updateCredential(UserCredentialModel.password("pass1"));
            r2user1.userCredentialManager().updateCredential(UserCredentialModel.password("pass2"));

            Assert.assertTrue(r1user1.userCredentialManager().isValid(UserCredentialModel.password("pass1")));
            Assert.assertFalse(r1user1.userCredentialManager().isValid(UserCredentialModel.password("pass2")));
            Assert.assertFalse(r2user1.userCredentialManager().isValid(UserCredentialModel.password("pass1")));
            Assert.assertTrue(r2user1.userCredentialManager().isValid(UserCredentialModel.password("pass2")));
