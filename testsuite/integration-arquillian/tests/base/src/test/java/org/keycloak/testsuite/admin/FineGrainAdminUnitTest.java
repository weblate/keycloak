...
public class FineGrainAdminUnitTest extends AbstractKeycloakTest {
    ...
    public static void setupDemo(KeycloakSession session) {
        ...
        admin.userCredentialManager().updateCredential(UserCredentialModel.password("password"));
    ...
    public static void setupUsers(KeycloakSession session) {
        ...
        nomapAdmin.userCredentialManager().updateCredential(UserCredentialModel.password("password"));
        ...
        anotherAdmin.userCredentialManager().updateCredential(UserCredentialModel.password("password"));
        ...
        authorizedUser.userCredentialManager().updateCredential(UserCredentialModel.password("password"));
        ...
        authorizedComposite.userCredentialManager().updateCredential(UserCredentialModel.password("password"));
        ...
        unauthorizedUser.userCredentialManager().updateCredential(UserCredentialModel.password("password"));

        UserModel unauthorizedMapper = session.users().addUser(realm, "unauthorizedMapper");
        unauthorizedMapper.setEnabled(true);
        unauthorizedMapper.userCredentialManager().updateCredential(UserCredentialModel.password("password"));
        ...
        groupManager.userCredentialManager().updateCredential(UserCredentialModel.password("password"));

        UserModel groupManagerNoMapper = session.users().addUser(realm, "noMapperGroupManager");
        groupManagerNoMapper.setEnabled(true);
        groupManagerNoMapper.userCredentialManager().updateCredential(UserCredentialModel.password("password"));
        ...
        clientMapper.userCredentialManager().updateCredential(UserCredentialModel.password("password"));
        ...
        clientManager.userCredentialManager().updateCredential(UserCredentialModel.password("password"));
        ...
        clientConfigurer.userCredentialManager().updateCredential(UserCredentialModel.password("password"));
        ...
        groupViewer.userCredentialManager().updateCredential(UserCredentialModel.password("password"));
    ...
    public static void setup5152(KeycloakSession session) {
        ...
        realmUser.userCredentialManager().updateCredential(UserCredentialModel.password("password"));
    }
    ...
    public void testUserPagination() {
        testingClient.server().run(session -> {
            ...
            customerAManager.userCredentialManager().updateCredential(UserCredentialModel.password("password"));
            ClientModel realmAdminClient = realm.getClientByClientId(Constants.REALM_MANAGEMENT_CLIENT_ID);
            ...
            regularAdminUser.userCredentialManager().updateCredential(UserCredentialModel.password("password"));
