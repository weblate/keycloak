...
//        notes.forEach(note -> note.setParent(null));
    ...
    public void setUserSessionId(String userSessionId) {
        this.userSessionId = UUID.fromString(userSessionId);
    }
    ...
    public Map<String, String> getNotes() {
        return Collections.unmodifiableMap(notes.stream().collect(Collectors.toMap(JpaClientSessionNoteEntity::getName, JpaClientSessionNoteEntity::getValue)));
    }
