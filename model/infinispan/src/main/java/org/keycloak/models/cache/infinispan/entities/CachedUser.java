...
public class CachedUser extends AbstractExtendableRevisioned implements InRealm  {
    ...
    public CachedUser(Long revision, RealmModel realm, UserModel user, int notBefore) {
        ...
        this.storedCredentials = new DefaultLazyLoader<>(userModel -> userModel.userCredentialManager().getStoredCredentialsStream().collect(Collectors.toCollection(LinkedList::new)), LinkedList::new);
    }
